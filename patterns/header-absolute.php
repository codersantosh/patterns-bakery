 ...
 * Slug: patterns-bakery/header-absolute
 * Categories: header
...
?>
<!-- wp:group {"className":"patterns-bakery-header at-pos at-z-idx","style":{"spacing":{"blockGap":"0px"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group patterns-bakery-header at-pos at-z-idx">
